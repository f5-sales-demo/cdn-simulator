...
El componente de laboratorio [origin-server](https://f5-sales-demo.github.io/origin-server/) proporciona aplicaciones web vulnerables para pruebas de seguridad.

| Propiedad | Valor |
|---|---|
| Documentación | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| Repositorio | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
...
|---|---|---|
| **CDN Edge** (este) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | Caché, encabezados de proveedor |
| **Servidor de Origen** | [origin-server](https://github.com/f5-sales-demo/origin-server) | Aplicaciones web vulnerables |
| **Configuración F5 XC** | Varios (waf, api-protection, bot-*, etc.) | Políticas de seguridad |

Cada componente publica documentación que los asistentes de IA leen para desplegar la infraestructura. El servidor de origen publica un [manifiesto de endpoints](https://github.com/f5-sales-demo/origin-server/releases/latest) como artefacto de GitHub Release que lista todas las rutas de aplicación y verificaciones de estado.
