...
Die [origin-server](https://f5-sales-demo.github.io/origin-server/)-Laborkomponente stellt anfällige Webanwendungen für Sicherheitstests bereit.

| Eigenschaft | Wert |
|---|---|
| Dokumentation | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
...
|---|---|---|
| **CDN-Edge** (diese) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | Caching, Anbieter-Header |
| **Ursprungsserver** | [origin-server](https://github.com/f5-sales-demo/origin-server) | Anfällige Webanwendungen |
| **F5 XC-Konfiguration** | Verschiedene (waf, api-protection, bot-*, usw.) | Sicherheitsrichtlinien |

Jede Komponente veröffentlicht Dokumentation, die KI-Assistenten lesen, um die Infrastruktur bereitzustellen. Der Ursprungsserver veröffentlicht ein [Endpunkt-Manifest](https://github.com/f5-sales-demo/origin-server/releases/latest) als GitHub-Release-Artefakt, das alle Anwendungspfade und Integritätsprüfungen auflistet.
