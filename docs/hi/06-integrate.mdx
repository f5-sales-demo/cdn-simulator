...
[origin-server](https://f5-sales-demo.github.io/origin-server/) लैब घटक सुरक्षा परीक्षण के लिए कमज़ोर वेब एप्लिकेशन प्रदान करता है।

| गुण | मान |
|---|---|
| दस्तावेज़ीकरण | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| रिपॉज़िटरी | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| डिफ़ॉल्ट पोर्ट | 80 |
...
|---|---|---|
| **CDN Edge** (यह) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | कैशिंग, विक्रेता हेडर |
| **ऑरिजिन सर्वर** | [origin-server](https://github.com/f5-sales-demo/origin-server) | कमज़ोर वेब ऐप |
| **F5 XC Config** | विभिन्न (waf, api-protection, bot-*, आदि) | सुरक्षा नीतियाँ |

प्रत्येक घटक दस्तावेज़ीकरण प्रकाशित करता है जिसे AI सहायक इंफ्रास्ट्रक्चर डिप्लॉय करने के लिए पढ़ते हैं। ऑरिजिन-सर्वर एक [एंडपॉइंट मेनिफेस्ट](https://github.com/f5-sales-demo/origin-server/releases/latest) GitHub Release आर्टिफ़ेक्ट के रूप में प्रकाशित करता है जिसमें सभी एप्लिकेशन पथ और हेल्थ चेक सूचीबद्ध हैं।
