...
[origin-server](https://f5-sales-demo.github.io/origin-server/) 实验室组件提供用于安全测试的存在漏洞的 Web 应用程序。

| 属性 | 值 |
|---|---|
| 文档 | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| 代码仓库 | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| 默认端口 | 80 |
| 健康检查 | `GET /health` |
...
| 组件 | 代码仓库 | 用途 |
|---|---|---|
| **CDN 边缘**（本组件） | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | 缓存、厂商报头 |
| **源服务器** | [origin-server](https://github.com/f5-sales-demo/origin-server) | 存在漏洞的 Web 应用程序 |
| **F5 XC 配置** | 各类（waf、api-protection、bot-* 等） | 安全策略 |

每个组件均发布供 AI 助手读取以部署基础设施的文档。源服务器以 GitHub Release 制品的形式发布[端点清单](https://github.com/f5-sales-demo/origin-server/releases/latest)，列出所有应用程序路径和健康检查信息。
