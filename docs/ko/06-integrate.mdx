...
[origin-server](https://f5-sales-demo.github.io/origin-server/) 랩 구성 요소는 보안 테스트를 위한 취약한 웹 애플리케이션을 제공합니다.

| 속성 | 값 |
|---|---|
| 문서 | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| 저장소 | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| 기본 포트 | 80 |
| 헬스 체크 | `GET /health` |
...
| 구성 요소 | 저장소 | 목적 |
|---|---|---|
| **CDN 시뮬레이터** (현재) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | 캐싱, 벤더 헤더 |
| **오리진 서버** | [origin-server](https://github.com/f5-sales-demo/origin-server) | 취약한 웹 앱 |
| **F5 XC 구성** | 다양함 (waf, api-protection, bot-* 등) | 보안 정책 |

각 구성 요소는 AI 어시스턴트가 인프라를 배포하기 위해 읽는 문서를 게시합니다. 오리진 서버는 모든 애플리케이션 경로와 헬스 체크를 나열하는 [엔드포인트 매니페스트](https://github.com/f5-sales-demo/origin-server/releases/latest)를 GitHub 릴리스 아티팩트로 게시합니다.
