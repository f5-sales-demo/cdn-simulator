...
يوفر مكوّن المختبر [origin-server](https://f5-sales-demo.github.io/origin-server/) تطبيقات ويب تحتوي على ثغرات مخصصة لاختبار الأمان.

| الخاصية | القيمة |
|---|---|
| التوثيق | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| المستودع | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| المنفذ الافتراضي | 80 |
...
|---|---|---|
| **حافة CDN** (هذا) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | التخزين المؤقت وترويسات البائع |
| **خادم المصدر** | [origin-server](https://github.com/f5-sales-demo/origin-server) | تطبيقات الويب المكشوفة |
| **إعدادات F5 XC** | متنوعة (waf, api-protection, bot-*, إلخ) | سياسات الأمان |

ينشر كل مكوّن وثائق تقرأها مساعدات الذكاء الاصطناعي لنشر البنية التحتية. يُصدر خادم المصدر [بيان نقطة النهاية](https://github.com/f5-sales-demo/origin-server/releases/latest) كأداة إصدار على GitHub تسرد جميع مسارات التطبيقات وفحوصات الصحة.
