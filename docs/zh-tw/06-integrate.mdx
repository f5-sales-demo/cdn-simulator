...
[origin-server](https://f5-sales-demo.github.io/origin-server/) 實驗室元件提供用於安全測試的易受攻擊網頁應用程式。

| 屬性 | 值 |
|---|---|
| 文件 | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| 儲存庫 | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| 預設連接埠 | 80 |
| 健康檢查 | `GET /health` |
...
| 元件 | 儲存庫 | 用途 |
|---|---|---|
| **CDN 邊緣**（本項） | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | 快取、廠商標頭 |
| **來源伺服器** | [origin-server](https://github.com/f5-sales-demo/origin-server) | 易受攻擊的網頁應用程式 |
| **F5 XC 設定** | 各種（waf、api-protection、bot-* 等） | 安全政策 |

每個元件均發布 AI 助理用於部署基礎設施的文件。來源伺服器以 GitHub Release 成品形式發布[端點清單](https://github.com/f5-sales-demo/origin-server/releases/latest)，列出所有應用程式路徑與健康檢查。
