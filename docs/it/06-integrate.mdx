...
Il componente lab [origin-server](https://f5-sales-demo.github.io/origin-server/) fornisce applicazioni web vulnerabili per i test di sicurezza.

| Proprietà | Valore |
|---|---|
| Documentazione | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
...
|---|---|---|
| **CDN Edge** (questo) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | Caching, header vendor |
| **Server di Origine** | [origin-server](https://github.com/f5-sales-demo/origin-server) | Applicazioni web vulnerabili |
| **Configurazione F5 XC** | Vari (waf, api-protection, bot-*, ecc.) | Policy di sicurezza |

Ogni componente pubblica documentazione che gli assistenti IA leggono per distribuire l'infrastruttura. Il server di origine pubblica un [manifest degli endpoint](https://github.com/f5-sales-demo/origin-server/releases/latest) come artefatto di GitHub Release che elenca tutti i percorsi delle applicazioni e i controlli di integrità.
