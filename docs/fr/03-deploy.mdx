...
description: >-
  ...
  F-series optimisée pour le calcul avec Ubuntu 24.04, réglage du noyau, cache
  proxy NGINX, keepalive upstream, compression gzip et plus de 67 en-têtes de
...
Tous les fichiers Terraform se trouvent dans le répertoire [`terraform/`](https://github.com/f5-sales-demo/cdn-simulator/tree/main/terraform). Clonez le dépôt et déployez directement :
