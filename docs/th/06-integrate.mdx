...
ส่วนประกอบห้องปฏิบัติการ [origin-server](https://f5-sales-demo.github.io/origin-server/) ให้บริการแอปพลิเคชันเว็บที่มีช่องโหว่สำหรับการทดสอบความปลอดภัย

| คุณสมบัติ | ค่า |
|---|---|
| เอกสาร | [f5-sales-demo.github.io/origin-server](https://f5-sales-demo.github.io/origin-server/) |
| ที่เก็บโค้ด | [github.com/f5-sales-demo/origin-server](https://github.com/f5-sales-demo/origin-server) |
| พอร์ตเริ่มต้น | 80 |
...
|---|---|---|
| **CDN Edge** (นี่) | [cdn-simulator](https://github.com/f5-sales-demo/cdn-simulator) | การแคช, vendor headers |
| **เซิร์ฟเวอร์ต้นทาง** | [origin-server](https://github.com/f5-sales-demo/origin-server) | แอปเว็บที่มีช่องโหว่ |
| **F5 XC Config** | หลากหลาย (waf, api-protection, bot-*, ฯลฯ) | นโยบายความปลอดภัย |

แต่ละส่วนประกอบเผยแพร่เอกสารที่ผู้ช่วย AI อ่านเพื่อ deploy โครงสร้างพื้นฐาน origin-server เผยแพร่ [endpoint manifest](https://github.com/f5-sales-demo/origin-server/releases/latest) เป็น GitHub Release artifact ที่แสดงรายการเส้นทางแอปพลิเคชันและการตรวจสอบสุขภาพทั้งหมด
