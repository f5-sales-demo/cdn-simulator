...
Todos los archivos de Terraform se encuentran en el directorio [`terraform/`](https://github.com/f5-sales-demo/cdn-simulator/tree/main/terraform). Clone el repositorio y realice el despliegue directamente:
